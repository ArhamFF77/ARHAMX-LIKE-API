...
def make_profile_check_request(encrypted_profile_payload, server_name, token_dict):
    ...
    if server_name == "PAK":
        url = "https://client.pak.freefiremobile.com/GetPlayerPersonalShow"
    elif server_name in {"BR", "US", "SAC", "NA"}:
...
def handle_requests():
    ...
    if server_name_param == "PAK":
        like_api_url = "https://client.pak.freefiremobile.com/LikeProfile"
